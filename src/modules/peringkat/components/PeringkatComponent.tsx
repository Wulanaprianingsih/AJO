...
export default function PeringkatComponent() {
  const leaderboard: IUser[] = [
    { id: 1, name: "Dewi Saraswati", xp: 12500 },
    { id: 2, name: "Bagus Pratama", xp: 11200 },
    { id: 3, name: "Rani Kusuma", xp: 10800 },
    { id: 4, name: "Arif Nugroho", xp: 9750 },
    { id: 5, name: "Putri Ayu", xp: 9400 },
    { id: 6, name: "Dimas Wicaksono", xp: 9100 },
    { id: 7, name: "Intan Maharani", xp: 8800 },
    { id: 8, name: "Fajar Santoso", xp: 8600 },
    { id: 9, name: "Larasati", xp: 8400 },
    { id: 10, name: "Adi Saputra", xp: 8200 },
    { id: 11, name: "Wulan Aprianingsih", xp: 7900 },
  ];

  const currentUser: IUser = { id: 11, name: "Wulan Aprianingsih", xp: 7900 };
